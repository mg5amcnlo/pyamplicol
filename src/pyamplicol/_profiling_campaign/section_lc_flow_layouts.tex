...
Within its LC scope, one compact process-seed artifact serves both measured
...
workloads are compared with a separately generated recurrence authority. The
same componentwise comparison is repeated after
...
full-colour entries are selector-free contracted evaluations: their cold stage
builds the requested helicity family and evaluates the authenticated sparse-NLC
or complete-colour contraction payload. They expose helicity selection but no
leading-colour flow selector.
