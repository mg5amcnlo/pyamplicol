...
def test_summary_boolean_cannot_replace_per_row_evidence() -> None:
    ...
    assert result["summary"]["failure_reason_counts"] == {"missing-record": 1256}
