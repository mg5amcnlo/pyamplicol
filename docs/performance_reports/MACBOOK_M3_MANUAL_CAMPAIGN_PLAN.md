...
- Keep outer wall time and accumulated evaluator-total time as independent clocks in result metadata and visualizations. Never fabricate evaluator-total or narrow phase attribution from wall time; tolerate unavailable narrow attribution.
