...
explicitly rather than inferred. For future compiled and eager entries, the
same repeated warmed boundary also retains its accumulated duration and total
point count as an authenticated evaluator-total measurement. Its absolute
per-point value is marked \(T\), never substituted for the narrower attribution
or ratioed against it. Older cache entries remain explicitly not exposed.
