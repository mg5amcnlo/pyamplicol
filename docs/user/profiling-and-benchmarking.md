...
Python may profile a higher-precision evaluator, but native component
attribution is f64-only. A non-f64 run therefore reports wall timing rather
than the Rusticol f64 breakdown. See [Python API](python-api.md) and
