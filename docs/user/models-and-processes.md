...
| --- | --- | --- |
| `built-in-sm` | Fast Standard Model compatibility workflows and prepared recurrence/eager kernels | No |
...
expressions, and one prepared local-kernel backend. It enables recurrence or
eager process generation without compiling each local kernel again.
