...
Prepared-model creation is measured separately and excluded from the
process-generation times in the comparison tables. This boundary is important:
the reported eager and recurrence generation times describe adding a process
to an already prepared model, not importing and compiling the model itself.
