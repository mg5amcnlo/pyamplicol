...
5. Complete the active model-independence hardening pass: consume
   `ContractionIR` and tensor-order metadata, prove colored-contact and
   all-adjoint reductions from canonical expressions, and run relabeled-PDG
   and reordered-tensor invariance checks before restoring
   topology/performance gates.
