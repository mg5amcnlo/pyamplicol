...
| Model independence hardening | Main + physics/model reviewers | In progress | Hand-written SM model, lowering, tensors, process catalog, selection, and validation are quarantined under `models.builtin`; shared process/color/DAG code consumes structural statistics, representation, anti-relation, source-orientation, and exact quantum-flow metadata; unsafe helicity/reflection reductions fail closed. Typed source/crossing/propagator/contraction records, expression-level external-model symmetry certificates, and relabeled/reordered adversarial fixtures remain | Pending |
...
5. Complete the active model-independence hardening pass: add the remaining
   typed source/crossing/propagator/contraction records, prove external-model
   symmetry reductions from canonical expressions, and run relabeled-PDG and
