...
5. Complete the active model-independence hardening pass after freezing the
   ...
   metadata, relabeled-PDG/source-inventory invariance, numerical spin-2
   component-axis/dummy-index invariance, model-owned `ContractionIR`,
