...
REQUIRED_SDIST_MEMBERS = frozenset(
    {
        ...
        "dependencies/patches/legacy-amplicol/0001-build-color-probe-without-lhapdf.patch",
        "dependencies/patches/legacy-amplicol/0002-report-complete-recursion-kinds.patch",
        "dependencies/patches/legacy-amplicol/0003-report-lc-row-partitions.patch",
