...
class Runtime:
    ...
    def save(self, path: str | PathLike[str]) -> None:
        """Save the retained on-the-fly recursion, without model parameters."""
        ...
    def load_cache(self, path: str | PathLike[str]) -> None:
        """Restore a saved recursion into the same loaded on-the-fly process."""
        ...
    ...
    def set_model_parameters(self, mapping: Mapping[str, ModelParameterValue]) -> None:
