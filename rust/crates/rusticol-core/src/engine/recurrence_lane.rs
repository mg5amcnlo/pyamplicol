...
impl DirectProfileSnapshot {
    fn capture(
        ...
        let mut traffic = runtime.traffic_counters();
        let (internal_scratch_bytes, internal_broadcast_bytes) = owners.internal_traffic_bytes();
        traffic.internal_scratch_bytes = traffic
            .internal_scratch_bytes
            .saturating_add(internal_scratch_bytes);
        traffic.internal_broadcast_bytes = traffic
            .internal_broadcast_bytes
            .saturating_add(internal_broadcast_bytes);
        Self {
...
fn direct_profile(
    ...
    let internal_scratch_bytes = after
        .traffic
        .internal_scratch_bytes
        .saturating_sub(before.traffic.internal_scratch_bytes);
    let internal_broadcast_bytes = after
        .traffic
        .internal_broadcast_bytes
        .saturating_sub(before.traffic.internal_broadcast_bytes);
